...
object NBATables {
  ...
  val raw_cache_table: PostgresTable = PostgresTable[CacheParams]("raw_cache_table")
  val frequency_cache_table: PostgresTable = PostgresTable[CacheParams]("frequency_cache_table")
  val compare_cache_table: PostgresTable = PostgresTable[CacheParams]("compare_cache_table")
