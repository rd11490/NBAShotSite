...
export class OffenseTeamSelectorComponent {
  ...
  constructor(private store: Store<Options>) {
    ...
    this.selectedItem = OptionSelectors.selectOffensiveTeam(this.store);
  }

  selectTeam(team: TeamId) {
    this.store.dispatch(new OptionActions.SetOffenseTeam(team));
  }
