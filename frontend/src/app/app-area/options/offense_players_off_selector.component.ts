...
export class OffensePlayersOffSelectorComponent {
  ...
  constructor(private store: Store<Options>) {
    ...
    this.selectedPlayers = OptionSelectors.selectOffensivePlayersOff(this.store);
  }

  selectPlayers(players: Array<PlayerId>) {
    this.store.dispatch(new OptionActions.SetOffensePlayersOff(players));
  }
