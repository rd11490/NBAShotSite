...
@Component({
  selector: 'fourfactors-3-season-select',
  template: `
    <div>
      Seasons
...
export class FourFactorsThreeSeasonSelectorComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seasons = InitialSelectors.selectThreeYearSeasons(this.store);
