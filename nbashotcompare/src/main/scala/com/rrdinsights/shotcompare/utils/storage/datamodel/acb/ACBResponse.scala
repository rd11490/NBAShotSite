package com.rrdinsights.shotcompare.utils.storage.datamodel.acb

import java.{ lang => jl }

final case class ACBResponse(
  clock: String,
  period: jl.Integer,
  periodType: String,
  inOT: jl.Integer,
...
final case class ACBCoachDetails(
  firstName: String,
  familyName: String,
  internationalFirstName: String,
  internationalFamilyName: String,
...
final case class ACBPlayByPlayEvent(
  gt: String,
  s1: jl.Integer,
  s2: jl.Integer,
  lead: jl.Integer,
